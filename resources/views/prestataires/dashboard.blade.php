<x-gmao-layout>
    ...
    <div class="row">
              ...
              <div class="row gy-3">
                <div class="col-md-3 col-6">
                  <div class="d-flex align-items-center">
                    <div class="p-2 badge rounded-pill bg-label-primary me-3"><i class="ti ti-chart-pie-2 ti-sm"></i></div>
                    <div class="card-info">
                ...
                <div class="col-md-3 col-6">
                  <div class="d-flex align-items-center">
                    <div class="p-2 badge rounded-pill bg-label-info me-3"><i class="ti ti-users ti-sm"></i></div>
                    <div class="card-info">
                ...
                <div class="col-md-3 col-6">
                  <div class="d-flex align-items-center">
                    <div class="p-2 badge rounded-pill bg-label-danger me-3"><i class="ti ti-shopping-cart ti-sm"></i></div>
                    <div class="card-info">
                ...
                <div class="col-md-3 col-6">
                  <div class="d-flex align-items-center">
                    <div class="p-2 badge rounded-pill bg-label-success me-3"><i class="ti ti-currency-dollar ti-sm"></i></div>
                    <div class="card-info">
        ...
        <div class="col-xl-4 col-12">
          <div class="row">
            <!-- Expenses -->
            <div class="mb-4 col-xl-6 col-md-3 col-6">
              <div class="card">
                <div class="pb-0 card-header">
                  <h5 class="mb-0 card-title">82.5k</h5>
                  <small class="text-muted">Expenses</small>
                </div>
                <div class="card-body">
                  <div id="expensesChart"></div>
                  <div class="mt-3 text-center mt-md-2 mt-lg-3">
                    <small class="mt-3 text-muted">$21k Expenses more than last month</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mb-4 col-xl-6 col-md-3 col-6">
              <div class="card">
                <div class="pb-0 card-header">
                  <h5 class="mb-0 card-title">Profit</h5>
                  ...
                  <div class="d-flex justify-content-between">
                    <div class="d-flex flex-column">
                      ...
                      <div class="chart-statistics">
                        <h3 class="mb-1 card-title">4,350</h3>
          ...
          <div class="card">
            <div class="p-0 card-body">
              <div class="row row-bordered g-0">
                <div class="p-4 col-md-8 position-relative">
                ...
                <div class="p-4 col-md-4">
                  ...
                  <h3 class="pt-4 mb-0 text-center">$25,825</h3>
        ...
        <div class="mb-4 col-xl-4 col-md-6">
          <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
              ...
              <div class="dropdown">
                <button class="p-0 btn" type="button" id="earningReports" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <ul class="p-0 m-0">
                <li class="mb-3 d-flex">
                  <div class="flex-shrink-0 avatar me-3">
                    <span class="rounded avatar-initial bg-label-primary"><i class='ti ti-chart-pie-2 ti-sm'></i></span>
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    ...
                    <div class="gap-3 user-progress d-flex align-items-center">
                      <small>$1,619</small>
                ...
                <li class="mb-3 d-flex">
                  <div class="flex-shrink-0 avatar me-3">
                    <span class="rounded avatar-initial bg-label-success"><i class='ti ti-currency-dollar ti-sm'></i></span>
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="mb-3 d-flex">
                  <div class="flex-shrink-0 avatar me-3">
                    <span class="rounded avatar-initial bg-label-secondary"><i class='ti ti-credit-card ti-sm'></i></span>
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
        ...
        <div class="mb-4 col-md-6 col-xl-4">
          <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
              ...
              <div class="dropdown">
                <button class="p-0 btn" type="button" id="popularProduct" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                </button>
            ...
            <div class="card-body">
              <ul class="p-0 m-0">
                <li class="pb-1 mb-4 d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/iphone.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="pb-1 mb-4 d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/nike-air-jordan.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="pb-1 mb-4 d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/headphones.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="pb-1 mb-4 d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/apple-watch.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="pb-1 mb-4 d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/amazon-echo.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                ...
                <li class="d-flex">
                  <div class="me-3">
                    <img src="/storage/assets/img/products/play-station.png" alt="User" class="rounded" width="46">
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
        ...
        <div class="mb-4 col-md-6 col-xl-4">
          <div class="card h-100">
            <div class="pb-2 mb-1 card-header d-flex justify-content-between">
              <div class="mb-1 card-title">
                <h5 class="m-0 me-2">Sales by Countries</h5>
                <small class="text-muted">62 Deliveries in Progress</small>
              </div>
              <div class="dropdown">
                <button class="p-0 btn" type="button" id="salesByCountryTabs" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                </button>
            ...
            <div class="card-body">
              <div class="nav-align-top">
                ...
                <div class="pb-0 tab-content">
                  <div class="tab-pane fade show active" id="navs-justified-new" role="tabpanel">
                    <ul class="pb-1 mb-2 timeline timeline-advance">
                      <li class="timeline-item ps-4 border-left-dashed">
                        <span class="timeline-indicator timeline-indicator-success">
                          <i class="ti ti-circle-check"></i>
                        </span>
                        <div class="pb-0 timeline-event ps-0">
                          <div class="timeline-header">
                            <small class="text-success text-uppercase fw-medium">sender</small>
                          </div>
                          <h6 class="mb-0">Myrtle Ullrich</h6>
                          <p class="mb-0 text-muted text-nowrap">101 Boulder, California(CA), 95959</p>
                        </div>
                      </li>
                      <li class="border-transparent timeline-item ps-4">
                        ...
                        <div class="pb-0 timeline-event ps-0">
                          ...
                          <p class="mb-0 text-muted text-nowrap">939 Orange, California(CA),92118</p>
                        </div>
                      </li>
                    </ul>
                    <div class="mt-0 mb-4 border-bottom border-bottom-dashed"></div>
                    <ul class="mb-0 timeline timeline-advance">
                      <li class="timeline-item ps-4 border-left-dashed">
                        <span class="timeline-indicator timeline-indicator-success">
                          <i class="ti ti-circle-check"></i>
                        </span>
                        <div class="pb-0 timeline-event ps-0">
                          ...
                          <p class="mb-0 text-muted text-nowrap">162 Windsor, California(CA), 95492</p>
                        </div>
                      </li>
                      <li class="border-transparent timeline-item ps-4">
                        <span class="timeline-indicator timeline-indicator-primary">
                        ...
                        <div class="pb-0 timeline-event ps-0">
                          ...
                          <p class="mb-0 text-muted text-nowrap">487 Sunset, California(CA), 94043</p>
                        </div>
                      </li>
                    </ul>
                  </div>
        ...
        <div class="mb-4 col-md-6 col-xl-4">
          <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
              ...
              <div class="dropdown">
                <button class="p-0 btn" type="button" id="transactionID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                </button>
            ...
            <div class="card-body">
              <ul class="p-0 m-0">
                ...
                <li class="pb-1 mb-3 d-flex align-items-center">
                  <div class="p-2 rounded badge bg-label-success me-3">
                ...
                <li class="pb-1 mb-3 d-flex align-items-center">
                  <div class="p-2 rounded badge bg-label-danger me-3">
                    <i class="ti ti-brand-paypal ti-sm"></i>
                  </div>
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                      <h6 class="mb-0">Paypal</h6>
                      <small class="mb-1 text-muted d-block">Client Payment</small>
                    </div>
                    <div class="gap-1 user-progress d-flex align-items-center">
                ...
                <li class="pb-1 mb-3 d-flex align-items-center">
                  ...
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                      ...
                      <small class="mb-1 text-muted d-block">Ordered iPhone 13</small>
                    </div>
                    <div class="gap-1 user-progress d-flex align-items-center">
                ...
                <li class="pb-1 mb-3 d-flex align-items-center">
                  ...
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                      ...
                      <small class="mb-1 text-muted d-block">Refund</small>
                    </div>
                    <div class="gap-1 user-progress d-flex align-items-center">
                ...
                <li class="d-flex align-items-center">
                  ...
                  <div class="flex-wrap gap-2 d-flex w-100 align-items-center justify-content-between">
                    <div class="me-2">
                      <h6 class="mb-0">Bank Transfer</h6>
                      <small class="mb-1 text-muted d-block">Pay Office Rent</small>
                    </div>
                    <div class="gap-1 user-progress d-flex align-items-center">
