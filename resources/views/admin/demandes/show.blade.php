        ...
        <div class="mb-4 col-lg-10 offset-md-1 col-md-10 offset-lg-1">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="p-0 btn" type="button" id="demandeActionsPanel" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="demandeActionsPanel">
                            <a class="text-white bg-blue-400 dropdown-item hover:bg-blue-600" href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#create-bt-offcanvas" align="right">
                                <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                                <span>NOUVEAU BON DE TRAVAIL</span>
                            </a>

                            <a class="text-white bg-violet-400 dropdown-item hover:bg-violet-600" href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#injection-piece-offcanvas" align="right">
                                <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                                <span>INJECTION DE PIECE</span>
                            </a>

                            <a class="text-white bg-green-400 dropdown-item hover:bg-green-600" href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#cloture-rapport-offcanvas" align="right">
                                <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            ...
                            <a class="text-white bg-yellow-400 dropdown-item hover:bg-yellow-600" href="{{route('admin.demandes.edit',$demande)}}">
                                <i class="ti ti-edit me-0 me-sm-1 ti-xs"></i>
                                <span>EDITER</span>
                                
                            </a>
                            <form 
                                action="{{route('admin.demandes.destroy',$demande)}}" 
                                method="post"
