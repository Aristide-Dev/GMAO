<div>
    <div class="mx-2 row">
        <div class="flex items-center justify-between mx-0 {{ !$monthlyReport->validated ? 'bg-red-100':'bg-green-100' }} rounded shadow-xl h-14 col-md-12">
            <h1 class="font-bold text-gray-500">
                RAPPORT MENSUEL: {{ $monthlyReport->title }}
            </h1>
        ...
        <div class="flex justify-between">
            <p class="mt-3 text-sm">
                Rapport Généré le {{ \Carbon\Carbon::parse($monthlyReport->created_at)->translatedFormat('l, d F Y à H\hi') }}
            </p>
    ...
    <div class="row">
        <div class="p-3 my-3 col-12">
            <livewire:rapports.evolution-requetes :monthlyReport="$monthlyReport"/>
        </div>
    </div>

    <div class="row">
        <div class="p-3 my-3 shadow col-12">
            <livewire:rapports.top-10-pannes :monthlyReport="$monthlyReport"/>
        </div>
    </div>

    <div class="row">
        <div class="p-3 my-3 shadow col-12">
            <livewire:rapports.requete-by-equipement-type :monthlyReport="$monthlyReport"/>
        </div>
    </div>

    <div class="row">
        <div class="p-3 my-3 shadow col-12">
            <livewire:rapports.requete-by-zone :monthlyReport="$monthlyReport"/>
        </div>
    </div>

    <div class="row">
        <div class="p-3 my-3 shadow col-12">
            <livewire:rapports.cout-total-maintenance :monthlyReport="$monthlyReport"/>
        </div>
    </div>
</div>
