        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr wire:loading.class="hidden">
                    ...
                    <td>
                        <div class="flex gap-1 flex-rows">
                            <a href="{{ route($url.'.demandes.show', $demande) }}" class="py-2 btn btn-primary">Suivis</a>
                            @if ($canDelete)
                                <button type="submit" wire:click.prevent='deleteDemande({{ $demande->id }})' class="text-white bg-red-500 btn hover:bg-red-600">Supprimer</button>
                            @endif
                        </div>
                    </td>
                </tr>
