<div>
    <div class="card-header row">
        ...
        <div class="col-12">
            ...
            @foreach ($formations as $formation)
                <div class="d-flex justify-content-between align-items-center mb-6 border-b p-2">
                    <div class="d-flex align-items-center">
                        <div>
                            <div>
                                <h6 class="mb-0 text-truncate font-bold h5">{{ $formation->title }}</h6>
                                <small class="text-truncate text-body">{{ $formation->description }}</small>
                            </div>
                        </div>
                    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddFormation"
        ...
        <div class="flex-grow-0 pt-0 mx-0 offcanvas-body h-100">
            <form wire:submit='store' class="pt-0 add-new-formation" id="addNewFormationForm"
                ...
                <div id="gmao_file_loder_contennaire">
                    <label class="gmao_file_loder">
                        <div class="gmao_file_loder-inner">
                            <span class="gmao_file_loder-text">Déposez le fichier PDF ici ou cliquez pour
                                télécharger</span>
                            <input wire:model="pdf_file" id="file-input" name="pdf_file" type="file"
                                accept=".pdf" />
                        </div>
