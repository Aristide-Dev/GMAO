        ...
        <div class="bg-white card-body">
            ...
            <div class="flex justify-between gap-1 my-3">
                <div class=">
                    ...
                    <p class="mb-1 uppercase">Numero Serie: <span class="font-bold ">{{ $equipement->numero_serie
                            }}<span></p>
                    <p class="mb-1 uppercase">Forfait Contrat: <span class="font-bold ">{{ number_format($equipement->forfait_contrat, 2, "."," ") }} F<span></p>
                </div>
            ...
            {{-- <div
                class="flex p-1 mx-auto mb-3 bg-yellow-200 shadow-xl rounded-xl row align-items-center justify-content-between">
                <div class="col">
                    <div class="d-flex">
                        <div>
                ...
                <div class="col">
                    <div class="p-0 d-flex text-end">
                        <div>
                            ...
                            <p class="m-0 mb-0 fw-bolder">{{ number_format($equipement->forfait_contrat, 2, "."," ") }}
                                F</p>
                        </div>
                    </div>
                </div>
